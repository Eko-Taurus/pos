...
<head>
    ...
    <meta name="description" content="Produk By ITATS">
    <meta name="author" content=" Kelompok KP">

    <title>Welcome To PT Intan Timur Elektrik</title>
   ...
   ?>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2019';?> by Kelompok KP ITATS</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
